...
这非常符合软件开发的[开闭原则（Open-Closed Principle）](https://en.wikipedia.org/wiki/Open%E2%80%93closed_principle)：Rust 可以通过宏、trait、泛型函数、trait object 等工具，帮助我们更容易写出结构良好、容易维护的代码。
